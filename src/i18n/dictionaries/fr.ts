...
const fr = {
  ...
  playerDrawer: {
    ...
    deck: 'Deck',
    deckAverageElixir: 'Élixir moyen : {average}',
    ...
    careerStatsTitle: 'Statistiques',
    careerWins: 'Victoires',
    careerLosses: 'Défaites',
    careerBattlesPlayed: 'Parties jouées',
    careerThreeCrownWins: 'Victoires à 3 couronnes',
    careerTotalDonations: 'Dons cumulés à vie',
    recentBattlesTitle: 'Combats récents',
    recentBattlesSummary: '{wins} victoires · {losses} défaites · {draws} nuls',
    recentBattlesUnavailableTitle: 'Combats indisponibles',
    recentBattlesUnavailableDescription:
      'Aucun combat recent exploitable pour ce profil.',
    battleResultWin: 'Victoire',
    battleResultLoss: 'Défaite',
    battleResultDraw: 'Match nul',
