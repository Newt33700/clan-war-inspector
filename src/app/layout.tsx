...
import { PlayerDrawerProvider } from './components/player-drawer-provider';
    ...
    <html lang={locale} className={`${displayFont.variable} ${bodyFont.variable}`}>
      <body className="text-royale-parchment flex min-h-screen flex-col font-sans antialiased">
        <LocaleProvider initialLocale={locale}>
          {/* Fiche joueur globale (US 9) : montee une fois ici pour que le
              code du joueur reste cliquable depuis n'importe quelle page,
              pas seulement le dashboard. */}
          <PlayerDrawerProvider>
            ...
            {/* flex-1 (2026-08-04) : pousse le footer en bas de l'ecran sur
                les pages courtes (etat idle "saisissez un clan") au lieu de
                le laisser flotter au milieu, entoure de damier vide.
