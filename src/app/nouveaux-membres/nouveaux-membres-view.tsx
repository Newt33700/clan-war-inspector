...
/**
 * Sas de quarantaine (US 11, Epique 13) : a besoin du clan (membres
 * actuels) et de riverracelog (3 dernieres semaines), comme l'historique
 * (`historique-view.tsx`), mais pas de la guerre en cours -- la
 * detection des nouveaux membres ne regarde que l'historique.
 */
...
export function NouveauxMembresView({
  tag,
  clanSeed,
  logSeed,
