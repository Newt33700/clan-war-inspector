  ...
  return (
    <footer className="pb-tab-bar bg-slate-900 px-6 py-4 text-xs text-slate-400 md:pb-4">
      <p className="mx-auto max-w-4xl">
        Ce contenu n&apos;est pas affilié, soutenu, sponsorisé ou spécifiquement approuvé
        par Supercell et Supercell n&apos;en est pas responsable. Pour plus
        d&apos;informations, veuillez consulter la politique relative aux contenus de fans
        de Supercell :{' '}
        <a
